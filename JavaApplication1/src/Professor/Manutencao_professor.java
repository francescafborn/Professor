 ...
 */
public class Manutencao_professor extends javax.swing.JDialog {

    /**
     * Creates new form Manutencao_professor
     */
    public Manutencao_professor(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Manutencao_professor.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Manutencao_professor dialog = new Manutencao_professor(new javax.swing.JFrame(), true);
